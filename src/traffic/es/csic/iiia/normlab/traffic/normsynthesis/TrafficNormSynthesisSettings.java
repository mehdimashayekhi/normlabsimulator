...
public class TrafficNormSynthesisSettings implements NormSynthesisSettings {
	...
	/* Frequency for cars to enter in the scenario ADDED BY MEHDI*/
	public static int SIM_NEW_CARS_FREQUENCY_EAST_WEST;
	...
	public static void init() {
		...
		SIM_NEW_CARS_FREQUENCY_EAST_WEST=(Integer)p.getValue("SimNewCarsFreqEW");  //ADDED BY MEHDI
		...
		// Constants for Gconfc, added by mehdi but probably won't use it
			NormEvaluationConstants gConfcConstants = new NormEvaluationConstants
					(NORM_WEIGHT_NO_COL, NORM_WEIGHT_COL, NORM_WEIGHT_FLUID_TRAFFIC, 1);

		GOAL_EVALUATION_CONSTANTS = new HashMap<Goal, NormEvaluationConstants>();
		GOAL_EVALUATION_CONSTANTS.put(gCols, gColsConstants);
		GOAL_EVALUATION_CONSTANTS.put(gConfc, gConfcConstants);
