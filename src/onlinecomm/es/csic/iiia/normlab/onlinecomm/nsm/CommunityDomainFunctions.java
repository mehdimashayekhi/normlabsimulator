...
public class CommunityDomainFunctions implements DomainFunctions {
	...
	@Override
	public EnvironmentAgentContext agentContextFunctionconf(long agentId, View view, List<Long> ids) {
		CommunityView sv = (CommunityView) view;
		int uploadListSize = sv.getActualUploadList().size();
		CommunityAgentContext agentContext = null;
	...
	@Override
	public EnvironmentAgentContext agentContextFunctioncol(long agentId, View view) {
		CommunityView sv = (CommunityView) view;
		int uploadListSize = sv.getActualUploadList().size();
		CommunityAgentContext agentContext = null;
