...
public class TrafficSimulator implements TrafficElement {
	...
	public void step() {
		...
		if(tick++ > 0) {
			...
			// 1. predict cars' positions one step ahead and generate norm
			carMap.step();		
...
//			trafficMetrics.print();
	...
	private void createPredicatesDomains() {
		...
		leftPredTaxonomy.addTerm("<");
		leftPredTaxonomy.addTerm(">");
		leftPredTaxonomy.addTerm("v");  // this has been added by mehdi because for the current map (3) it needs to be added, 
		leftPredTaxonomy.addTerm("w");  // this has been added by mehdi because of the new context
		leftPredTaxonomy.addTerm("^");  // this has been added by mehdi because of the new context
		leftPredTaxonomy.addTerm("-");
		leftPredTaxonomy.addRelationship("<", "*");
		leftPredTaxonomy.addRelationship(">", "*");
		leftPredTaxonomy.addRelationship("-", "*");
		leftPredTaxonomy.addRelationship("v", "*"); // added by mehdi
		leftPredTaxonomy.addRelationship("w", "*"); // added by mehdi
		leftPredTaxonomy.addRelationship("^", "*"); // added by mehdi
		
		/* Predicate "left2" domain added by mehdi*/
		TaxonomyOfTerms leftPredTaxonomy2 = new TaxonomyOfTerms("l2", leftPredTaxonomy);
		...
		/* Predicate "front2" domain added by mehdi*/
		TaxonomyOfTerms frontPredTaxonomy2 = new TaxonomyOfTerms("f2", leftPredTaxonomy);
		frontPredTaxonomy2.addTerm("^");
		frontPredTaxonomy2.addRelationship("^", "*");
		...
		this.predDomains.addPredicateDomain("f2", frontPredTaxonomy2); //added by mehdi
		this.predDomains.addPredicateDomain("l2", leftPredTaxonomy2); // added by mehdi
	}
