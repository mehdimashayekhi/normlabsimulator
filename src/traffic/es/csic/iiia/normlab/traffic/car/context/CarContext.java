...
public class CarContext extends TrafficMatrix implements EnvironmentAgentContext {
	...
	public static int NUM_ROWS = 2; //this has changed from 1 to 2 by mehdi
	public static int NUM_COLS = 4;  // this has changed from 3 to four by mehdi
	protected Type type;
	...
	public void packmod(TrafficFactFactory factFactory) {
		
		/* Generate description in the form of predicates and terms */
		this.description = factFactory.generatePredicatesmod(this);
	...
	public void packmodconf(TrafficFactFactory factFactory) {
		
		/* Generate description in the form of predicates and terms */
		this.description = factFactory.generatePredicatesmodconf(this);
